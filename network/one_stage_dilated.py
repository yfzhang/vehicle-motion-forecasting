...
class OneStageDilated(nn.Module):
    """
    Hybrid Dilated CNN with 3*3 filters
    kinematic related information will be directly feed to higher layers
    """

    def __init__(self, feat_in_size=10, feat_out_size=25, regression_hidden_size=32, viz = False):
        super(OneStageDilated, self).__init__()
